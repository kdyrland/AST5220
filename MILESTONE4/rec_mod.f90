...
!        logtau(i) = log(tau(i))
    ...
    call spline(xrec, tau2, yp1, ypn, tau22)    ! tau2 contains the second derivative values

    ! dtau
    do i = 1,n
        dtau(i) = get_dtau(xrec(i))             ! uses splint to find first derivatives
    end do

! or can find directly
!    do i = 1,n
!        Hrec(i) = get_H(xrec(i))
!    end do
!    do i = 1,n
