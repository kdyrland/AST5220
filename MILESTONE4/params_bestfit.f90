module params
  ...
  real(dp), parameter :: omega_m      = 0.200d0     !0.224d0
  real(dp), parameter :: omega_r      = 8.3d-5
  real(dp), parameter :: omega_nu     = 0.d0
  real(dp), parameter :: omega_v      = 0.7299d0    !1.d0 - omega_m - omega_b - omega_r - omega_nu
  real(dp), parameter :: T0           = 2.725d0
  real(dp), parameter :: n_s          = 0.8d0       !1.0d0
  ...
  real(dp), parameter :: eps_0        = 13.605698d0 * eV
  real(dp), parameter :: m_e          = 9.10938188d-31
  real(dp), parameter :: m_H          = 1.673534d-27
  real(dp), parameter :: sigmaT       = 6.652462d-29
  ...
  real(dp), parameter :: kb           = 1.3806503d-23
